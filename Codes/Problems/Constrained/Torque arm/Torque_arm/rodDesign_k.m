function[Edof, Ex, Ey, numfenod, numfele]=rodDesign_k(s,draw)
%
% function[Edof, Ex, Ey]=rodDesign(s);
%
% design element module for generating fe meshes
%
% input:    s = [s1 s2 s3 s4 s5 s6 s7] - design parameters
%
% output:   Edof - Element connectivity  
%           Ex   - Nodal x-coordinates for elements
%           Ey   - Nodal y-coordinates for elements
%           numfenod - total number of FE nodes
%           numfele  - total number of finite elements
%
...
tp=[2  3   1   23  2   13  1   33  14  3;
    ...
    2  8   19  29  5   8   0   0   0   0;
    2  22  9   6   30  22  0   0   0   0;
    2  31  32  19  8   7   25  31  0   0;  
    2  32  10  26  11  15  17  18  19  32; 
    2  12  10  26  32  22  21  20  16  12;
    2  22  32  31  7   25  9   22  0   0;  
    2  11  10  26  12  16  10  34  15  11 ];
...
for i=1:numfele
   ...
   case 3
      for j=1:4  
         ...
         Edof(i,j*2)=fetopo(i,j+1)*2 - 1;
         Edof(i,j*2+1)=fetopo(i,j+1)*2;
      end
   end
end
